...
<head>
    ...
    <title> Information for addministrator </title>
...
To find Student ID please press "Ctrl + F" then fill ID.
		...
		<tr>
			...
			<td>
				<a href="view_student.php?did=<?= $stu_id ?>" class="btn btn-secondary"
					role="button">View</a>
				<a href="delete_student.php?did=<?= $stu_id ?>" class="btn btn-danger"
					role="button" onClick="return confirm('Delete this department?')">Delete</a>
			</td>
